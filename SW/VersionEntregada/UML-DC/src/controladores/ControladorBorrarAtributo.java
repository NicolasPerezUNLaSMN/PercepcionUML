...
public class ControladorBorrarAtributo extends HttpServlet {
...
private void procesarPeticion(HttpServletRequest request, HttpServletResponse response)
			...
			try {
				...
				int idAtributo=Integer.parseInt(request.getParameter("idAtributo"));
				...
				atributoabm.eliminar(idAtributo);
