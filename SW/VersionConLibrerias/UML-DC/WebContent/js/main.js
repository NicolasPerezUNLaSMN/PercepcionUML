$(document).ready(function(){
	...
	$('.btn-exit-system').on('click', function(){
		swal({
		  	title: '¿Está seguro?',
		  	text: "Usted volvera al menu principal",
		  	type: 'warning',
		  	showCancelButton: true,
		  	confirmButtonColor: '#03A9F4',
		  	cancelButtonColor: '#F44336',
		  	confirmButtonText: '<i class="zmdi zmdi-run"></i> Si, vamos!',
		  	cancelButtonText: '<i class="zmdi zmdi-close-circle"></i> No, me he equivocado!'
		}).then(function () {
